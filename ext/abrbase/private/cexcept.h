...
void init_exception_context(struct exception_context *ec);
    ...
    by other means must be initialised using this macro before they
    are used by a Try/Catch statement.  It does no harm to initialise
    a context more than once (by using this macro on a statically
    allocated context, or using this macro twice on the same context),
    but a context must not be re-initialised after it has been used by a
    Try/Catch statement.
...
Catch (expression) statement
    ...
    The Try/Catch/Throw macros are capitalised in order to avoid
